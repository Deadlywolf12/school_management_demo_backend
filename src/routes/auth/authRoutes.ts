...
import { getProfile, reqOtp, signin, signup, resendOtp, changePassword as changePassword } from "../../controllers/authController";
import { validate } from "../../middleware/validate";
import {changePasswordSchema, requestOtpSchema, resendOtpSchema, loginSchema as signinSchema, signupSchema } from "../../validators/auth/authValidators";
